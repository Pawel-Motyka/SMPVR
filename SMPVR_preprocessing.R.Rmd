...
#write.table(data, file = "SMPVR_raw_data_processed", sep = "\t")
...
#data <- read.table("SMPVR_raw_data_processed", header = TRUE, sep = "\t", fill = TRUE, stringsAsFactors = FALSE)
...
#write.table(data_d, file = "SMPVR_main_data_processed", sep = "\t")
