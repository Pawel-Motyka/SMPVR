...
#####**1. Load the required packages and the processed data** 
...
psych::describe(data_alt_ID_direction$alterations[data_alt_ID_direction$direction == "forward"])
psych::describe(data_alt_ID_direction$alterations[data_alt_ID_direction$direction == "backward"])
